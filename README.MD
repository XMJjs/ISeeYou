...
**Due to academic commitments, development of this project is currently suspended. If you are interested in taking over and maintaining it, please feel free to contact me.**
...
> 
> Currently, only [Leaves](https://github.com/LeavesMC/Leaves), [Leaf](https://github.com/Winds-Studio/Leaf) and [Lophine](https://github.com/LuminolMC/Lophine) provide that.
>
...
CommandAPI 11.2.0 is bundled and isolated inside ISeeYou for Minecraft 26.1 compatibility. No separate CommandAPI plugin is required.

### How to install

1. **Install the Plugin**: Place the plugin file in the plugins directory of the server, and restart the server.
